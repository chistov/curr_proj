...
THREE.PlaneTypedGeometry = function ( width, height, widthSegments, heightSegments, color ) {
	...
	var colors = new Float32Array( gridX1 * gridY1 * 3 );
	...
	this.setArrays( indices, vertices, normals, colors, uvs );
